...
insert into USERS (id, email, password, fullname, enabled) values (3, 'donat.udvari@ponte.hu', '{bcrypt}$2a$10$YvjRz/VbU3ScVa.GnmeGJ.EEkBPwY9m8I1YxOX5dJ0AhM2prFHZKO', 'Ponte Donát', true);
