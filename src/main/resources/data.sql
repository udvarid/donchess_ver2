...
insert into USERS (id, email, password, fullname, enabled) values (2, 'udvarid@hotmail.com', '{bcrypt}$2a$10$YvjRz/VbU3ScVa.GnmeGJ.EEkBPwY9m8I1YxOX5dJ0AhM2prFHZKO', 'Udvari Donát - 1', true);
